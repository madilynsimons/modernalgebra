...
$\mathbb{Z}/2\mathbb{Z}$ is $x^2 + x + 1$.  Therefore, if $h(x)$ is reducible,
then it is divisible by $x^2 + x + 1$ in $\mathbb{Z}/2\mathbb{Z}$.  However,
$h(x)$ is NOT divisible by $x^2 + x + 1$, so it must be irreducible.
